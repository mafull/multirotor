...
const Gpio_ConfigData_t Gpio_configData[Gpio_Instance_MAX] = 
    {
        ...
        */
        ...
        // External Interrupts
        [Gpio_MPU6050_Int] = { GPIOD, {  GPIO_PIN_4, GPIO_MODE_IT_RISING, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,               0 } },
        ...
        // Timer 2
        [Gpio_Tim2_Ch1]    = { GPIOA, {  GPIO_PIN_0,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF1_TIM2 } },
        [Gpio_Tim2_Ch2]    = { GPIOA, {  GPIO_PIN_1,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF1_TIM2 } },
        [Gpio_Tim2_Ch3]    = { GPIOA, {  GPIO_PIN_2,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF1_TIM2 } },
        [Gpio_Tim2_Ch4]    = { GPIOA, {  GPIO_PIN_3,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF1_TIM2 } },
        // Timer 3
        [Gpio_Tim3_Ch1]    = { GPIOC, {  GPIO_PIN_6,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF2_TIM3 } },
        [Gpio_Tim3_Ch2]    = { GPIOC, {  GPIO_PIN_7,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF2_TIM3 } },
        [Gpio_Tim3_Ch3]    = { GPIOC, {  GPIO_PIN_8,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF2_TIM3 } },
        [Gpio_Tim3_Ch4]    = { GPIOC, {  GPIO_PIN_9,     GPIO_MODE_AF_PP, GPIO_NOPULL,  GPIO_SPEED_FREQ_LOW,   GPIO_AF2_TIM3 } },
        // Timer 4
